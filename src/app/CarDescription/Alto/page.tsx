      ...
      <div className="w-full max-w-lg flex flex-col items-center border p-6 rounded-lg shadow-lg">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-700">
            ...
            <strong>Engine:</strong> 660 CC <br />
            <strong>Condition:</strong> 9 / 10 <br />
            <strong>Driven:</strong> 5,000 KM <br />
            <strong>Suspension Type:</strong> Standard Suspension <br />
            <strong>Avg:</strong> 20 Km per L <br />
            <strong>Transmission:</strong> Automatic <br />
            <strong>Fuel Type:</strong> Regular Paterol
          </p>
        </div>
